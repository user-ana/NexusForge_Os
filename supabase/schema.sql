...
alter table public.class_tasks add column if not exists audience text default 'all';
alter table public.class_tasks add column if not exists show_on_publish boolean default true;
alter table public.class_tasks add column if not exists group_submission boolean default false;
