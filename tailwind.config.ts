  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-accent': 'linear-gradient(135deg, #35D6EC 0%, #1089D3 100%)',
        'glow-violet': 'radial-gradient(circle, rgba(63, 195, 232, 0.2) 0%, transparent 70%)',
      ...
      boxShadow: {
        ...
        'glow-violet': '0 0 20px rgba(63, 195, 232, 0.3), 0 0 40px rgba(92, 201, 240, 0.2)',
